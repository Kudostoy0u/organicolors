    ...
    <div className="about-section text-start">
      <Container className="container-sm w-50">
        ...
        <p className="text-center text-lg-start fs-6 fs-lg-5">
          It doesn't matter if you copy one person's homework or copy a multitude of different homework and mix them into one, the end result is the same, it is an unoriginal, pre-existing piece of work. However, the more serious issue is that what AI is copying is more than just homework, it is copying human art, created from experience, lessons, and emotions. <br/><br/>
